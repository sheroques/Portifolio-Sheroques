        ...
        >
          ...
          >
            <p className="text-muted-foreground max-w-md text-lg">
              Transformando código em soluções prontas para produção através de automação e boas práticas.
            </p>

            <div className="flex gap-4">
              <button className="px-8 py-4 bg-accent-blue text-white font-medium uppercase tracking-wider hover:bg-primary-blue transition-colors duration-300">
                Ver Projetos
              </button>
              <button className="px-8 py-4 border-2 border-accent-blue text-accent-blue font-medium uppercase tracking-wider hover:bg-accent-blue hover:text-white transition-all duration-300">
                Contato
              </button>
            </div>
          </div>
